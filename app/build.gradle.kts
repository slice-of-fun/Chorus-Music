...
android {
    namespace = "pushkar.chorus.music"
    compileSdk = 36
...
//add nightly build label support
        ...
        val discordApplicationId = "1538302367584362536"
        val discordApplicationIdLong = 1538302367584362536L
...
dependencies {
    ...
    implementation(project(":chorusmusiccanvas"))
