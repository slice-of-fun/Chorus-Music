package pushkar.chorus.music.db
...
import pushkar.chorus.music.db.entities.AlbumArtistMap
import pushkar.chorus.music.db.entities.AlbumEntity
import pushkar.chorus.music.db.entities.AlbumWithSongs
...
import pushkar.chorus.music.db.entities.EventWithSong
...
import pushkar.chorus.music.db.entities.PlayCountEntity
...
import pushkar.chorus.music.db.entities.SetVideoIdEntity
import pushkar.chorus.music.db.entities.Song
import pushkar.chorus.music.db.entities.SongAlbumMap
import pushkar.chorus.music.db.entities.SongArtistMap
import pushkar.chorus.music.db.entities.SongEntity
import pushkar.chorus.music.db.entities.SongWithStats
import pushkar.chorus.music.extensions.reversed
import pushkar.chorus.music.extensions.toSQLiteQuery
...
interface DatabaseDao {
    ...
    @Transaction
    @Query("SELECT * FROM song WHERE isDownloaded ORDER BY rowId")
    fun downloadedSongsByRowIdAsc(): Flow<List<Song>>

    @Transaction
    @Query("SELECT * FROM song WHERE isDownloaded ORDER BY dateDownload")
    ...
    @Transaction
    @Query("SELECT * FROM song WHERE isDownloaded ORDER BY totalPlayTime")
    ...
    fun downloadedSongs(
        ...
        SongSortType.ARTIST ->
            downloadedSongsByRowIdAsc().map { songs ->
                val collator = Collator.getInstance(Locale.getDefault())
                collator.strength = Collator.PRIMARY
                songs
                    .sortedWith(
