...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: pushkar.chorus.music.constants.PlaybackEngine = pushkar.chorus.music.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == pushkar.chorus.music.constants.PlaybackEngine.POTOKEN || engine == pushkar.chorus.music.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == pushkar.chorus.music.constants.PlaybackEngine.BRAVEPIPE || engine == pushkar.chorus.music.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
