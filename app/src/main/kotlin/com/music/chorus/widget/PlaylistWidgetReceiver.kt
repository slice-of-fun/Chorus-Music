...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "pushkar.chorus.music.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "pushkar.chorus.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "pushkar.chorus.music.widget.playlists.UPDATE_WIDGET"
