...
import pushkar.chorus.music.constants.ListenTogetherAutoApprovalKey
import pushkar.chorus.music.constants.ListenTogetherIsHostKey
import pushkar.chorus.music.constants.ListenTogetherRoomCodeKey
import pushkar.chorus.music.constants.ListenTogetherServerUrlKey
import pushkar.chorus.music.constants.ListenTogetherSessionTimestampKey
import pushkar.chorus.music.constants.ListenTogetherSessionTokenKey
import pushkar.chorus.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "pushkar.chorus.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "pushkar.chorus.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "pushkar.chorus.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "pushkar.chorus.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(pushkar.chorus.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[pushkar.chorus.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
