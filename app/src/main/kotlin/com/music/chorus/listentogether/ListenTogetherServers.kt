...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/ChorusMusicApp/Chorus-Music/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Chorus Music Server",
                url = "wss://iad1tya-chorusmusic.hf.space/ws",
                location = "Global",
                operator = "CHORUS"
            )
        )
