...
import pushkar.chorus.music.constants.AutomixDebugOverlayKey
...
import pushkar.chorus.music.constants.EnableGoogleCastKey
import pushkar.chorus.music.constants.HistoryDuration
import pushkar.chorus.music.constants.KeepScreenOn
...
import pushkar.chorus.music.constants.SeekExtraSeconds
...
highlightKey: String? = null) {
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = pushkar.chorus.music.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        ...
        defaultValue = pushkar.chorus.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    isHighlighted = (highlightKey == stringResource(R.string.seek_seconds_addup)),
                ...
                add(Material3SettingsItem(
    isHighlighted = (highlightKey == stringResource(R.string.chorus_equalizer)),
                    icon = painterResource(R.drawable.chorusequlizer),
                    title = { Text(stringResource(R.string.chorus_equalizer)) },
                    description = { Text(stringResource(R.string.chorus_equalizer_desc)) },
    ...
    isHighlighted = (highlightKey == stringResource(R.string.export_desc)),
                ...
                Material3SettingsItem(
                    ...
                    onClick = { navController.navigate("settings/chorus_extractor") }
                )
            )
        )
