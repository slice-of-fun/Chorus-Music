...
import pushkar.chorus.music.constants.MaxImageCacheSizeKey
...
import pushkar.chorus.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    pushkar.chorus.music.playback.ExoDownloadService::class.java,
                    false
                )
