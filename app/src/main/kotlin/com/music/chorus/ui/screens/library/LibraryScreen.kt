...
fun LibraryScreen(navController: NavController) {
    ...
    if (showYoutubeImportDialog) {
        ...
        pushkar.chorus.music.ui.component.TextFieldDialog(
    ...
    if (showCreatePlaylistDialog) {
        pushkar.chorus.music.ui.component.CreatePlaylistDialog(
    ...
    if (showAiPlaylistDialog) {
        pushkar.chorus.music.ui.component.CreateAiPlaylistDialog(
