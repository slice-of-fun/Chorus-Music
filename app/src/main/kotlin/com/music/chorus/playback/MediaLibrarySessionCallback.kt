...
import pushkar.chorus.music.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(pushkar.chorus.music.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun pushkar.chorus.music.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
