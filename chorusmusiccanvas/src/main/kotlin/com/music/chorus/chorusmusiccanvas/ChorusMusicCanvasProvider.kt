...
object chorusmusicCanvasProvider {
    private const val BASE_URL = "https://canvas.chorusmusic.fun/canvas.json"
    ...
    private data class CacheEntry(
        val value: chorusmusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): chorusmusicCanvasManifest? {
        ...
        return try {
            val manifest: chorusmusicCanvasManifest = client.get(BASE_URL).body()
